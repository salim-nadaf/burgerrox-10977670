        ...
        <div className="grid md:grid-cols-2 gap-8 items-start max-w-4xl mx-auto">
          ...
          <div className="text-center md:text-left space-y-3">
            <nav className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-1 text-sm" aria-label="Legal and info links">
              <Link to="/privacy" className="text-background hover:text-primary transition-colors">
                Privacy
              </Link>
              <Link to="/refund-policy" className="text-background hover:text-primary transition-colors">
                Refund Policy
              </Link>
              <Link to="/terms" className="text-background hover:text-primary transition-colors">
                Terms & Conditions
              </Link>
              <Link to="/delivery-area" className="text-background hover:text-primary transition-colors">
                Delivery Area
              </Link>
            </nav>
            <p className="font-montserrat text-sm text-background/90">
              © 2026 Burger Rox. All rights reserved.
            </p>
            <p className="font-montserrat text-xs text-background/80">
          ...
          <address className="text-center md:text-right not-italic">
            <div className="font-montserrat text-sm text-background space-y-2">
              <p>Urban Forest, Mamurdi</p>
              <p className="font-semibold text-primary text-base">
                <a href="tel:+919321389985" aria-label="Call us at 9321389985">9321389985</a>
              </p>
              <p>
                <a href="mailto:cloudspicepvtltd@gmail.com" className="text-background hover:text-primary transition-colors" aria-label="Email us">cloudspicepvtltd@gmail.com</a>
              </p>
              ...
              <nav className="flex justify-center md:justify-end space-x-4 mt-4" aria-label="Social media links">
                ...
                >
                  <svg className="w-6 h-6 animate-pulse-subtle" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
